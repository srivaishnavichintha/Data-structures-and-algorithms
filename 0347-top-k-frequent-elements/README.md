<h2><a href="https://leetcode.com/problems/top-k-frequent-elements/?envType=problem-list-v2&envId=hash-table">347. Top K Frequent Elements</a></h2><h3>Medium</h3><hr><p>Given an integer array <code>nums</code> and an integer <code>k</code>, return <em>the</em> <code>k</code> <em>most frequent elements</em>. You may return the answer in <strong>any order</strong>.</p>
